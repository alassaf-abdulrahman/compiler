...
38,121,1,0,0,0,40,41,3,2,1,0,41,42,5,0,0,1,42,1,1,0,0,0,43,46,3,4,2,0,44,
45,5,19,0,0,45,47,3,2,1,0,46,44,1,0,0,0,46,47,1,0,0,0,47,50,1,0,0,0,48,50,
...
0,117,35,1,0,0,0,118,119,5,23,0,0,119,37,1,0,0,0,120,122,5,26,0,0,121,120,
...
export default class YourLanguageParser extends antlr4.Parser {
	...
	block() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) === 0 && ((1 << _la) & 67108926) !== 0)) {
	            this.state = 95;
	            this.commandList();
	        }
...
YourLanguageParser.ERROR_CHAR = 26;
YourLanguageParser.WS = 27;
